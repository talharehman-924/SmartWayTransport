  ...
  return (
    <div ref={pdfRef} style={{
      ...
      <div className="pdf-card">
        ...
        <div style={{ marginBottom: '12px', color: '#64748b', fontSize: '14px', position: 'relative', zIndex: 1, marginTop: '12px' }}>
          Total Passengers: <strong>{(Number(bookingData.adults) || 0) + (Number(bookingData.children) || 0)}</strong> ({(Number(bookingData.adults) || 0)} Adults, {(Number(bookingData.children) || 0)} Children)
        </div>
        <div className="pdf-grid" style={{ marginTop: '0' }}>
          ...
          <div className="pdf-grid-item">
            ...
            <div className="pdf-fake-field">
              {bookingData.luggageSuitcase || 0}S {bookingData.luggageHandCarry || 0}H {bookingData.luggageCarton || 0}C {bookingData.luggageStroller || 0}St {bookingData.luggageWheelchair || 0}W
            </div>
          </div>
        </div>
        ...
        <div className="pdf-grid">
          ...
          <div className="pdf-grid-item" style={{ gridColumn: 'span 2' }}>
            <label>Route / Package</label>
            <div className="pdf-fake-field">{bookingData.package || '-'}</div>
          </div>
        </div>
        <div className="pdf-grid">
          <div className="pdf-grid-item">
            <label>Total Payment (SAR)</label>
